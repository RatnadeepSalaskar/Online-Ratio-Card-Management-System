  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_brand_modal" class="btn btn-primary btn-sm">Add User</a>
      	</div>
      </div>
        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="brand_title" class="form-control" placeholder="Enter User Name">
		        	</div>
        		</div>
        		<input type="hidden" name="add_brand" value="1">
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-brand">Add User</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-brand-btn">Update User</button>
            </div>
          </div>
