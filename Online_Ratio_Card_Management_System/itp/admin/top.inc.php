               ...
               <ul class="nav navbar-nav">
                  ...
                  <?php if($_SESSION['ADMIN_ROLE']!=1){?>
				   <li class="menu-item-has-children dropdown">
                     <a href="vendor_management.php" > SHOP MANAGEMENT </a>
                  </li>
				  <li class="menu-item-has-children dropdown">
				  ...
				  <!-- <li class="menu-item-has-children dropdown">
                     <a href="coupon_master.php" > OFFER </a>
                  </li> -->
				  <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="https://gujarati.cdn.zeenews.com/gujarati/sites/default/files/2022/04/25/381927-rationcarddkk.jpg" alt="Logo" width="120" height="60"></a>
