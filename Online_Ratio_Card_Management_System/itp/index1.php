...
<head>
	...
	<title>ONLINE RATION CARD MANAGEMENT</title>
...
<body>
                ...
                <li><a href="#">Log in</a>
                    <div class="sub-menu">
                        <ul>
                            ...
                            <li><a href="http://localhost/pro/admin/index.php">Shop</a></li>
                        </ul>
					</div>
                </li>
	...
	<section id="hero-image">
		<div class="hero-text">
			<h1>ONLINE RATION CARD MANAGEMENT</h1>
		</div>
		...
		<div class="flex-container">
			<div class="flex-item1">
				<div class="content1">
					<h1>"Mera Ration"</h1>
						<div class="prap">
						<p>'One nation one ration card'</p>
						</div>
				</div>
			</div>
			<div class="flex-item1" id="flex-image">
				<div class="content2">
					<img src="https://en.gaonconnection.com/wp-content/uploads/2021/12/356828-free-ration-scheme-uttar-pradesh-refined-oil-pulses-salt-with-wheat-rice-5.jpg" alt="Image">
				</div>
			</div>
		</div>
	</section>
...
if(isset($_POST['email'])) {
    ...
    $email_to = "ratnadeepsalaskar@gmail.com";
